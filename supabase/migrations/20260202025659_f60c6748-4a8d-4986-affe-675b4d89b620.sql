-- Correção definitiva: Recriar função com SET LOCAL row_security = off
-- Isso garante que o RLS seja desabilitado durante a execução da função SECURITY DEFINER
...
BEGIN
  -- CRÍTICO: Desabilitar RLS para esta transação
