...
export default function Reports() {
  ...
  // Compute the server-side date range — push filtering to the database
  ...
  // Pass dateRange directly to query — no more fetching ALL history
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="sales" className="mt-4 space-y-6">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {dateRangeType === "custom" && customDate
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              {/* Top Products */}
              <Card className={dateRangeType !== "today" ? "lg:col-span-2" : ""}>
                <CardHeader>
