...
/**
 * Actions-only hook for subscription operations.
 * Subscription STATE lives exclusively in AuthContext (useAuth).
 * This hook only exposes checkout / portal actions.
 */
